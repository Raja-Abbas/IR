...
function HeroSection() {
  return (
    <div className="flex justify-between mx-24 xl:mx-[250px] 2xl:justify-center 2xl:gap-80 items-center mt-16 xl:mt-24 2xl:mt-36 max-lg:flex-col max-lg:gap-10 max-md:mx-0">
      <div className="flex flex-col gap-2 text-white max-lg:ml-10 max-md:ml-8">
